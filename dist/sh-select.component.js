...
var ShSelectComponent = (function () {
    ...
    ShSelectComponent.prototype.updateFilter = function (filter) {
        ...
        if (!this.isMultiselect && this.rawOptionGenerator) {
            var rawOption = this.rawOptionGenerator(filter);
            if (rawOption)
                this.filteredData.unshift(rawOption);
        }
        this.updateRows(this.filteredData);
    };
    ShSelectComponent.prototype.clearFilter = function () {
        if (this.filter === "")
            return;
        this.filter = "";
...
exports.ShSelectProvider = ShSelectProvider;
//# sourceMappingURL=sh-select.component.js.map